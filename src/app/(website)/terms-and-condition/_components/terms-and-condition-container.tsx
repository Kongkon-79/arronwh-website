...
import {
  ...
  TERMS_CONDITIONS_QUERY_KEY,
} from "./terms-and-condition-data-type";

const formatTermsDate = (dateValue?: string) => {
    ...
    <main className="min-h-screen bg-white px-4 py-10 sm:px-6 md:px-8 md:py-12">
      <div className="container mx-auto">
        <div className="mb-10 text-center">
          ...
          <Skeleton className="mx-auto mt-3 h-4 w-[300px]" />
          <Skeleton className="mx-auto mt-2 h-4 w-[260px]" />
        </div>
    ...
    <main className="min-h-screen bg-white px-4 py-10 sm:px-6 md:px-8 md:py-12">
      <div className="container">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-xs md:text-base font-medium leading-normal text-black">
            {termsCondition?.subtitle ||
              "Please read these terms carefully before using our services. By accessing YOLO HEAT you agree to be bound by these terms and conditions."}
          </p>

          <p className="mt-2 text-xs md:text-sm font-medium leading-normal text-black">
            Last updated : {formatTermsDate(termsCondition?.updatedAt || termsCondition?.createdAt)}
          </p>
        </div>
        ...
        {isError ? (
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-3">
                <p className="text-base font-semibold leading-normal md:text-lg">
                  We could not load the terms and conditions
                </p>
          ...
          <div className="rounded-lg border border-[#DDE4EC] bg-[#F8FAFC] p-4 text-center text-sm text-[#2D3D4D] md:text-base">
            No terms and conditions found at the moment.
          </div>
        ) : (
          <div
